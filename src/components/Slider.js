        ...
        <div className="glide__track" data-glide-el="track">
          <div className={classNames('glide__slides', styles.slides)} ref={slides}>
            ...
            <div className={classNames('glide__slide', styles.slide)} data-aos="fade-left" data-aos-duration="500" data-aos-easing="ease-out-quad" data-aos-delay="400">
              ...
              <div className={classNames(styles.text, fonts.small)}>
                В 2007 году на ВМЗ ОМК построил металлургический комплекс стан-5000.
              </div>
            </div>
            ...
            <div className={classNames('glide__slide', styles.slide)}>
              ...
              <div className={classNames(styles.text, fonts.small)}>
                Мощность стана-5000 — 1,5 млн т широкого стального листа в год. Самый современный толстолистовой стан в стране обеспечивает завод листом для производства труб большого диаметра до 1420 мм. На нем работает тысяча сотрудников
              </div>
            </div>
            ...
            <div className={classNames('glide__slide', styles.slide)}>
              ...
              <div className={classNames(styles.text, fonts.small)}>
                В 2008 году на площадке ВМЗ ОМК построил литейно-прокатный комплекс по выпуску стали для труб малого и среднего диаметра
              </div>
            </div>
            ...
            <div className={classNames('glide__slide', styles.slide)}>
              ...
              <div className={classNames(styles.text, fonts.small)}>
                В 2017 году в Выксе ОМК построил трубоэлектросварочный цех № 1 в рамках программы технического перевооружения и модернизации производства обсадных, насосно-компрессорных и нефтегазопроводных труб
              </div>
            </div>
            ...
            <div className={classNames('glide__slide', styles.slide)}>
              ...
              <div className={classNames(styles.text, fonts.small)}>
                В 1982 году в Выксе был запущен трубоэлектросварочный цех No 4, выпускающий трубы большого диаметра. Однако они не подходили для постройки больших магистральных трубопроводов
              </div>
            </div>
            ...
            <div className={classNames('glide__slide', styles.slide)}>
              ...
              <div className={classNames(styles.text, fonts.small)}>
                После постройки Объединенной металлургической компанией новых станов на ВМЗ, здесь первым в России началось производство труб для магистральных трубопроводов такого качества и объемов, что впоследствии позволило отказаться от их импорта. Текущая мощность цеха по выпуску труб большого диаметра ВМЗ — до 2 млн тонн труб в год. Он работает в связке с толстолистовым станом-5000 и участком по нанесению антикоррозионного покрытия
              </div>
            </div>
