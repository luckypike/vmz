  ...
  return (
    <div className={styles.investment}>
      ...
      <div className={styles.description}>
        Динамика экспорта ТБД после ввода производства прямошовных одношовных труб большого диаметра «русского размера» на ВМЗ и последующего запуска других российских производств
      </div>
    </div>
  )
}
