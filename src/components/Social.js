          ...
          <div className={styles.salary_2003}>
            <div className={styles.money}>
              ...
              <div className={classNames(styles.vyksa, {[styles.animated]: visible })}>
                ...
                <div className={classNames(styles.desc, fonts.small)}>
                  Средняя заработная плата на Выксунском металлургическом заводе<br />в 2003 году
                </div>
              </div>
            </div>
          </div>
          ...
          <div className={styles.salary_2019}>
            <div className={styles.money}>
              ...
              <div className={classNames(styles.vyksa, {[styles.animated]: visible })}>
                ...
                <div className={classNames(styles.desc, fonts.small)}>
                  Средняя заработная плата на Выксунском металлургическом заводе<br />в 2019 году
                </div>
              </div>
            </div>
          </div>
      ...
      <div className={styles.book}>
        <div className={styles.wrapper}>
          ...
          <div className={styles.container}>
            <div className={styles.text}>
              В ноябре в издательстве «Альпина» вышла документально-публицистическая книга «Русский размер. История трубы, или новая индустриализация» Владислава Дорофеева. Главную роль в ней играет Выксунский металлургический завод. Книга написана в стиле авторского репортажа о жизни и работе выксунских металлургов.
            </div>
          </div>
        </div>
      </div>
