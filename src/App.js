      ...
      <section>
        ...
        <div className={styles.pics}>
          ...
          <div className={styles.pipe}>
            ...
            <div className={styles.text}>
              За 20 лет ОМК произвела в Выксе более 30 млн тонн труб общей протяженностью 70 тыс. км — это рекорд среди российских предприятий. Трубами ВМЗ можно практически дважды обогнуть экватор.
            </div>
          </div>
        </div>
