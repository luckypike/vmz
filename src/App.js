      ...
      <section>
        ...
        <div className={styles.worldwide}>
          <div className={styles.world}>
            ...
            <div className={styles.text}>
              За 20 лет Объединенной металлургической компании (ОМК) удалось создать в Центральной России комплекс по производству стали, проката, труб большого диаметра (ТБД) и железнодорожных колес мирового класса. На заводе ОМК в Выксе выпускаются изделия любого уровня сложности.
            </div>
          </div>
        ...
        <div className={styles.pics}>
          ...
          <div className={styles.pipe}>
            ...
            <div className={styles.text}>
              За 20 лет ОМК произвела в Выксе более 30 млн тонн труб общей протяженностью 70 тыс. км — это рекорд среди российских предприятий. Трубами ВМЗ можно было бы почти дважды обогнуть экватор
            </div>
          </div>
        </div>
        ...
        <div className={styles.pipes}>
          ...
          <div className={styles.stream}>
            В проекте «Северный поток — 1» ОМК была первой и единственной российской компанией, допущенной до участия в поставках, объем которых превысил 500 км. труб.
          </div>
        </div>
      </section>
      ...
      <section>
        ...
        <div className={styles.projects}>
          ...
          <div className={styles.investment}>
            <div className={classNames(fonts.h3, styles.title)}>
              Открытие производства труб большого диаметра на Выксунском заводе в 2005 году — наиболее яркий пример промышленного импортозамещения в России
            </div>
